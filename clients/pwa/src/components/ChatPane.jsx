      ...
      <Show when={!noPeers()}>
        <div class="chat-layout">
          <div class="peer-list">
            ...
            return (<button class={`peer-item ${isActive() ? "active" : ""}`} onClick={() => setActivePeer(peer.peerId)}>
          ...
          <div class="chat-area" ref={chatAreaRef}>
            ...
            return (<div class={`message-group ${isMine ? "mine" : "theirs"}`}>
              ...
              <div class="input-row">
                <input type="text" value={draft()} onInput={(e) => setDraft(e.currentTarget.value)} onKeyDown={(e) => e.key === "Enter" && send()} placeholder="Type a message..."/>
