...
const ru: TranslationKeys = {
  ...
  settings_notif_blocked: "Заблокировано системой. Включите уведомления в настройках устройства для приложения.",
  ...
  settings_anonymous_title: "Анонимный транспорт",
  settings_anonymous_enabled: "Включен",
  settings_anonymous_disabled: "Выключен",
  settings_anonymous_help: "Используйте blind inbox и мосты Tor, когда их поддерживает текущий клиент.",
  settings_anonymous_apply: "Применить настройки транспорта",
  ...
  toast_notif_denied: "Разрешение на уведомления отклонено системой",
