const en = {
  ...
  settings_notif_blocked: "Blocked by the operating system. Enable notifications in system settings for this app.",
  ...
  settings_anonymous_title: "Anonymous Transport",
  settings_anonymous_enabled: "Enabled",
  settings_anonymous_disabled: "Disabled",
  settings_anonymous_help: "Use blind inbox routing and optional Tor bridges when the runtime supports them.",
  settings_anonymous_apply: "Apply transport settings",
  ...
  toast_notif_denied: "Notification permission denied by the operating system",
